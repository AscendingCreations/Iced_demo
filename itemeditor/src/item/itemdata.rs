...
pub struct ItemData {
    ...
    pub reqstat: u8,
    pub reqstatlvl: u16,
    pub combatstats: BuffCombatstats,
    pub skillstats: Skillstats,
    pub data: [i16; 20],
...
impl ItemData {
    ...
    pub fn load_files() -> Result<Vec<(ItemData, bool)>, String> {
        ...
        for i in 0..MAX_ITEMS {
            ...
            if result.1 {
                if let Err(e) = result.0.save_file(i) {
                    return Err(e);
                }
...
pub fn data_labels(id: usize, item_type: ItemTypes) -> String {
    match item_type {
        ...
        ItemTypes::ScriptMain => String::from("None"),
        ItemTypes::ScriptRange => String::from("None"),
        ItemTypes::ScriptRepeater => String::from("None"),
        ItemTypes::ScriptEffect => String::from("None"),
        ItemTypes::ScriptPower => String::from("None"),
        ItemTypes::ScriptCast => String::from("None"),
        ItemTypes::ScriptData => String::from("None"),
